...
CustomKeywords.'com.kazurayam.ks.ContextTrace.status'()
...
WebUI.callTestCase(findTestCase('Common Test Cases/Login - modularized'), [('Username') : 'John Doe', ('Password') : 'ThisIsNotAPassword'],
